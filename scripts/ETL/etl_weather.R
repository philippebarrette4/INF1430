...
rawDF <- read_csv(
    here::here("Data/Bronze", "Climate_HourlyWeather.csv"),
    col_types = cols(
...
write_csv(goldHourlyDF,     append = FALSE, file = here::here("Data/Gold/Weather", "gold_hourly_weather.csv"),   col_names = TRUE)
# Daily weather Data Frame
write_csv(goldDailyDF,      append = FALSE, file = here::here("Data/Gold/Weather", "gold_daily_weather.csv"),    col_names = TRUE)
# Monthly weather Data Frame
write_csv(goldMonthlyDF,    append = FALSE, file = here::here("Data/Gold/Weather", "gold_monthly_weather.csv"),  col_names = TRUE)